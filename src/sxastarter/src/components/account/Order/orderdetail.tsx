...
import OrderInfo from 'components/account/Order/OrderInfo/OrderInfo';
import ReviewOrderTotal from 'components/checkout/ReviewOrder/ReviewOrderTotal';
import BillingAddressReview from 'components/checkout/ReviewOrder/BillingAddressReview';
import ShippingAddressReview from 'components/checkout/ReviewOrder/ShippingAddressReview';
import PickUpReview from 'components/checkout/ReviewOrder/PickUpReview';
import ShipingMethodReview from 'components/checkout/ReviewOrder/ShipingMethodReview';
import PaymentMethodReview from 'components/checkout/ReviewOrder/PaymentMethodReview';
import ReviewCartItem from 'components/checkout/ReviewOrder/ReviewCartItem';
