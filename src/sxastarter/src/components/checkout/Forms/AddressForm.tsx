...
import { BillingAddress } from 'components/checkout/FormModel/billingaddress';
...
const AddressForm = (props: BillingAddressProps) => {
  ...
  const useSubmitBillingAddressForm = () => {
    const onSubmit = useCallback(
      (values: BillingAddress, { setSubmitting, setErrors }: FormikHelpers<BillingAddress>) => {
        console.log(countryId);
        values.CountryId = countryId;
        if (values.Id != 0) {
          CheckoutService.updateAddress(values)
          ...
          CheckoutService.addBillingAddress(values)
            .then(function (response) {
              if (response.data) {
                handleAddressSubmition(response.data);
              }
          ...
          <Form noValidate className={'bg-light p-3'}>
            ...
            <div className={'my-3'}>
              <TextField
                ...
                required={true}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('FirstName', formikProps)}
              />
            </div>
            <div className={'my-3'}>
              <TextField
                ...
                required={true}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('LastName', formikProps)}
              />
            </div>
            <div className={'my-3'}>
              <TextField
                ...
                required={true}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('Email', formikProps)}
              />
            </div>
            <div className={'my-3'}>
              <TextField
                ...
                type={'text'}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('Company', formikProps)}
              />
            </div>
            <div className={'my-3'}>
              <TextField
            ...
            <div className={'my-3'}>
              <TextField
                ...
                fullWidth
                select
                {...formikFieldAttrs<BillingAddress>('StateProvinceId', formikProps)}
              >
            ...
            <div className={'my-3'}>
              <TextField
                ...
                required={true}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('City', formikProps)}
              />
            </div>
            <div className={'my-3'}>
              <TextField
                ...
                required={true}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('Address1', formikProps)}
              />
            </div>
            <div className={'my-3'}>
              <TextField
                ...
                required={true}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('Address2', formikProps)}
              />
            </div>
            <div className={'my-3'}>
              <TextField
                ...
                required={true}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('ZipPostalCode', formikProps)}
              />
            </div>
            <div className={'my-3'}>
              <TextField
                ...
                required={true}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('PhoneNumber', formikProps)}
              />
            </div>
            <div className={'my-3'}>
              <TextField
                ...
                type={'phone'}
                fullWidth
                {...formikFieldAttrs<BillingAddress>('FaxNumber', formikProps)}
              />
            </div>
