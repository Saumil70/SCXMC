...
import BillingAddressSection from 'components/checkout/Address/BillingAddressSection';
import ShippingAddressSection from 'components/checkout/Address/ShippingAddressSection';
import ShippingMethodSection from 'components/checkout/ShippingMethod/ShippingMethodSection';
import PaymentMethodSection from 'components/checkout/PaymentMethod/PaymentMethodSection';
import PaymentInformationSection from 'components/checkout/PaymentInformation/PaymentInformationSection';
import OrderReviewSection from 'components/checkout/ReviewOrder/OrderReviewSection';
